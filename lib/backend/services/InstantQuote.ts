...
import { InstantQuote } from "../model/InstantQuote";
import nodemailer from 'nodemailer';
import {customerTemplate, instantTemplate } from "../utils/emailTemplate";

import fs from 'fs';
import path from 'path';
import { fileURLToPath } from 'url';
import { EMAIL, PASS } from "../config/index";
...
export const testIPDetection = catchAsyncError(async (req, res, next) => {
  const { getClientIP } = await import('../utils/ipDetection');
