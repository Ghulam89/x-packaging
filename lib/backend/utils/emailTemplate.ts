...
export const customerTemplate = (data: TemplateData) => `<!DOCTYPE html>
  <html>
  <head>
...
export const adminTemplate = (data: TemplateData) => `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
export const instantTemplate = (data: TemplateData) => `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
