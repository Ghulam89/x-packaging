/** Card grid data for category tabs section 2 (ported from CRA `constants/cardData.js`). */

const materialImage =
  "https://www.halfpricepackaging.com/_ipx/f_webp&q_70&s_200x200/images/products/material/white.jpg";

export type CardItem = { id: number; image: string; title: string; description: string };

export const materialsCards: CardItem[] = [
  {
    id: 1,
    image: materialImage,
    title: "Kraft Material",
    description:
      "Eco-friendly kraft material perfect for sustainable packaging solutions with natural brown appearance.",
  },
  {
    id: 2,
    image: materialImage,
...
export const printingOptionsCards: CardItem[] = [
  {
    id: 1,
    image: materialImage,
...
export const inksCards: CardItem[] = [
  {
    id: 1,
    image: materialImage,
...
export const finishingCards: CardItem[] = [
  {
    id: 1,
    image: materialImage,
    title: "UV Coating",
...
export const shapesAddonsCards: CardItem[] = [
  {
    id: 1,
    image: materialImage,
    title: "Custom Shapes",
