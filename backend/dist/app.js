...
if (isProduction && cluster.isPrimary) {
  ...
  if (isProduction) {
    try {
      ...
      const serverRender = serverModule && serverModule.render || serverModule && serverModule.default && serverModule.default.render || serverModule && serverModule.default;
    ...
    try {
      if (!isProduction && vite) {
        try {
          ...
          render = serverModule && serverModule.render || serverModule && serverModule.default && serverModule.default.render || serverModule && serverModule.default;
        } catch (error) {
