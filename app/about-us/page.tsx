...
export default function About() {
  ...
  const gallery  = [
    ASSETS.videos.gallery[0],
    ASSETS.videos.gallery[1],
    ASSETS.videos.gallery[2],
    ASSETS.videos.gallery[3],
  ...
  return (
    <div className="font-sans selection:bg-red-500 selection:text-white bg-gray-50 text-slate-800">
      ...
      {/* <CreativePackaging/> */}
      {/* <CreativeGallery products={gallery.map((url, idx) => ({ _id: `gallery-${idx}`, slug: `gallery-item-${idx}`, url }))} /> */}
  ...
  <div className="max-w-8xl mx-auto relative z-10">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
      {[
        { country: "USA", address: "9854 National Blvd #1042, Los Angeles, CA 90034", flag: ASSETS.flags.usa},
        { country: "UK", address: "275 New North Road, Islington, Suite 1946, London", flag:ASSETS.flags.uk},
        { country: "Canada", address: "7398 Yonge St #6d, Thornhill, ON L4J 8J2", flag:ASSETS.flags.canada}, // Fixed variable name
        { country: "Australia", address: "7398 Yonge St #6d, Thornhill, ON L4J 8J2", flag:ASSETS.flags.australia},
        { country: "UAE", address: "7398 Yonge St #6d, Thornhill, ON L4J 8J2", flag:ASSETS.flags.uae},
        { country: "China", address: "7398 Yonge St #6d, Thornhill, ON L4J 8J2", flag:ASSETS.flags.china}, // Fixed variable name
      ].map((loc, idx) => (
