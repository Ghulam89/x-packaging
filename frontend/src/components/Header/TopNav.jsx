      ...
      <div className="sm:max-w-8xl max-w-[95%] py-1 mx-auto">
        <div className="flex sm:justify-between justify-center flex-wrap items-center  sm:py-2 py-1.5 border-b border-gray-200 text-sm text-gray-700 gap-4">
          ...
          <div className="flex items-center space-x-2">
            <a href="#" aria-label="Facebook" className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center hover:bg-[#EE334B] group transition-colors">
              <FaFacebookF size={14} className="text-gray-600 group-hover:text-white transition-colors" />
            </a>
            <a href="#" aria-label="Twitter" className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center hover:bg-[#EE334B] group transition-colors">
              <FaXTwitter size={14} className="text-gray-600 group-hover:text-white transition-colors" />
            </a>
            <a href="#" aria-label="Instagram" className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center hover:bg-[#EE334B] group transition-colors">
              <FaInstagram size={14} className="text-gray-600 group-hover:text-white transition-colors" />
            </a>
            <a href="#" aria-label="Pinterest" className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center hover:bg-[#EE334B] group transition-colors">
              <FaPinterest size={14} className="text-gray-600 group-hover:text-white transition-colors" />
            </a>
            <a href="#" aria-label="YouTube" className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center hover:bg-[#EE334B] group transition-colors">
              <FaYoutube size={14} className="text-gray-600 group-hover:text-white transition-colors" />
            </a>
            <a href="#" aria-label="LinkedIn" className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center hover:bg-[#EE334B] group transition-colors">
