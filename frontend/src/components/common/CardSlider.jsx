  ...
  return (
    <div className="relative">
      <div
        ...
        className="scroll-container sm:pl-0 pl-4 items-start gap-4 flex productOverflow overflow-x-auto overflow-y-hidden whitespace-nowrap custom-scrollbar pb-4 py-2 snap-x snap-mandatory min-h-[320px] sm:min-h-[380px] md:min-h-[420px]"
