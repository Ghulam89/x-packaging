...
const TestimonialCard = ({ testimonial }) => {
  ...
  return (
    <div className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm flex flex-col gap-4 text-left w-[320px] md:w-[350px] shrink-0 pb-4">
      ...
      <p className="italic text-zinc-400 text-[11px] mt-auto">
        Ana Rodrigues, {testimonial.role}
      </p>
    </div>
  );
};
