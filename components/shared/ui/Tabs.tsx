    ...
    <div className="w-full">
          ...
          {tabs.map((tab) => {
            ...
            return (
              ...
              >
                ...
                <span className="relative z-10 whitespace-nowrap" style={isActive ? { color: "#ffffff" } : {}}>
                  {tab.title}
                </span>
              </button>
            );
      ...
      <div className="mt-8 relative w-full min-w-0">
        {tabs.map((tab) => {
          ...
          return (
            <div key={tab.title} className={`w-full min-w-0 ${direction === "right" ? "animate-slideInRight" : "animate-slideInLeft"}`}>
              <div className="animate-fadeInUp w-full min-w-0">{tab.content}</div>
            </div>
          );
        })}
      </div>
